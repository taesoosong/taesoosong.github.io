...
**First**, I integrate new housing, policy, and household data sources—such as consumer reference data, property assessor records, and local housing and zoning databases—with computational and geospatial methods to track how housing supply impacts residential mobility and neighborhood change at fine geographic and temporal scales. These analyses clarify how processes like gentrification, new housing construction, upzoning, and property sales shape where people live and move. My work has been published in the _Journal of the American Planning Association_, _Urban Studies_, and _Cityscape_.
